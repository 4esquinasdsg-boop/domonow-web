...
const problems = [
  ...
  { title: "Explicaste la decisión, pero generó conflicto", desc: "Aunque comunicaste, la gente no está de acuerdo." },
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          <h2 className="text-h3 md:text-h2 font-medium text-torre leading-snug">
            Trabajas día y noche, pero los residentes siguen <span className="inline-block border-2 border-domo rounded-full px-4 py-1 mx-1 italic font-serif bg-white">inconformes</span>
