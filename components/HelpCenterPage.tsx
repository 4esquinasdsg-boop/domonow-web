    ...
    resident: [
      {
        ...
        items: [
          { id: "res-1", title: "¿Cómo iniciar sesión y acceder a la plataforma?", videoId: "M7fiCo4tQfk" },
          { id: "res-2", title: "¿Cómo personalizar y actualizar tu información personal?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        section: "Solicitudes",
        ...
        items: [
          { id: "res-3", title: "¿Cómo crear una solicitud a la administración?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        ...
        icon: <Layers size={24} />,
        items: [
          { id: "res-4", title: "¿Cómo reservar un área común?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        ...
        items: [
          { id: "res-5", title: "¿Cómo activar el botón de emergencia?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        ...
        items: [
          { id: "res-6", title: "¿Cómo interactuar en el muro de comunicaciones?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        section: "Accesos",
        icon: <User size={24} />,
        items: [
          { id: "res-7", title: "¿Cómo crear un pase de acceso?", videoId: "M7fiCo4tQfk" }
        ]
      }
    ],
    admin: [
      {
        ...
        icon: <BookOpen size={24} />,
        items: [
          { id: "adm-1", title: "¿Cómo crear y gestionar publicaciones?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        section: "Solicitudes",
        icon: <HelpCircle size={24} />,
        items: [
          { id: "adm-2", title: "¿Cómo gestionar solicitudes de residentes?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        section: "Accesos",
        icon: <User size={24} />,
        items: [
          { id: "adm-3", title: "¿Cómo administrar el historial de accesos?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        section: "Áreas comunes",
        icon: <Layers size={24} />,
        items: [
          { id: "adm-4", title: "¿Cómo configurar reservas de áreas comunes?", videoId: "M7fiCo4tQfk" }
        ]
      },
      {
        ...
        items: [
          { id: "adm-5", title: "¿Cómo configurar roles y permisos?", videoId: "M7fiCo4tQfk" }
        ]
      }
    ],
    security: [
      {
        ...
        icon: <ShieldCheck size={24} />,
        items: [
          { id: "sec-1", title: "¿Cómo validar pases de acceso?", videoId: "M7fiCo4tQfk" }
        ]
      }
    ]
  };
                ...
                <div className={`flex p-1 bg-arquitectura rounded-[1.5rem] w-full md:w-auto overflow-x-auto no-scrollbar transition-opacity duration-300 ${searchQuery ? 'opacity-50 pointer-events-none md:opacity-100 md:pointer-events-auto' : ''}`}>
                    {roles.map((role) => (
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-3 rounded-[1.2rem] text-small font-bold transition-all duration-300 whitespace-nowrap ${
                                activeRole === role.id && !searchQuery
                      ...
                      {searchResults.length > 0 ? (
                          <div className="grid md:grid-cols-2 gap-6">
                              {searchResults.map((item) => (
                                  <div 
                                    key={item.id}
                                    className={`group rounded-2xl p-5 border transition-all duration-300 bg-white ${
                                        activeVideo === item.id 
