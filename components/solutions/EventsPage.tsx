...
export const EventsPage: React.FC<EventsPageProps> = ({ onOpenDemo }) => {
  ...
  const useCases = [
    { category: "Integración", description: "Actividades de integración para residentes", icon: <Users size={20} />, image: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&q=80&w=800" },
    { category: "Convivencia", description: "Campañas de convivencia", icon: <Megaphone size={20} />, image: "https://images.unsplash.com/photo-1577962917302-cd874c4e31d2?auto=format&fit=crop&q=80&w=800" },
    { category: "Cupos", description: "Eventos con cupo limitado (talleres, charlas, clases)", icon: <ListChecks size={20} />, image: "https://images.unsplash.com/photo-1544367563-12123d8965cd?auto=format&fit=crop&q=80&w=800" },
    { category: "Organización", description: "Actividades organizadas por la administración", icon: <CalendarCheck size={20} />, image: "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?auto=format&fit=crop&q=80&w=800" }
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
            <div className="lg:w-5/12 relative z-20">
              <span className="inline-block py-1.5 px-4 rounded-full bg-purple-50 border border-purple-100 text-domo text-tiny font-bold tracking-widest uppercase mb-6">Módulo 10</span>
              <h1 className="text-h2 md:text-h1 font-bold leading-tight mb-6 text-torre"><span className="text-domo">Eventos</span></h1>
              <div className="prose text-lead text-gray-500 mb-8 leading-relaxed">
                <p>DomoNow te permite <strong>planear, comunicar y gestionar eventos</strong> desde un solo lugar, con control real y participación clara.</p>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <div className="relative inline-block">
              ...
              <p className="relative z-10 text-h4 text-gray-500 leading-relaxed font-medium">"Organizar eventos suele convertirse en un caos, debido a la baja participación, desorden y actividades que no cumplen su objetivo de unir a la comunidad."</p>
            </div>
          </div>
