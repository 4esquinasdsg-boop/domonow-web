    ...
    <div className="pt-20 bg-white font-sans text-torre">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
            <div className="lg:w-5/12 relative z-20">
              <div className="flex items-center gap-3 mb-0">
                ...
                <span className="text-base font-bold tracking-widest uppercase text-domo">NORMATIVO</span>
              </div>
              <p className="text-small text-gray-400 italic mb-4 ml-12">Cumplimiento legal organizado y sin sorpresas</p>
              ...
              <div className="prose text-lead text-gray-500 mb-8 leading-relaxed">
                ...
                <p>
                  <strong className="text-torre"><span className="domonow-gradient">DomoNow</span> centraliza vencimientos.</strong> Alertas automáticas, sin sorpresas.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            <div className="bg-[#F9F5FF] p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-domo/5 border border-purple-100 group hover:border-domo/30 transition-colors duration-300 flex flex-col h-full">
              ...
              <div className="space-y-8 flex-grow">
                {[{ title: "Cumplimiento preventivo", desc: "Estado de todas tus obligaciones" }, { title: "Control unificado", desc: "Todo en un solo lugar con responsables asignados" }, { title: "Tranquilidad operativa", desc: "Alertas que te avisan para actuar sin estrés" }].map((item, i) => (
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-transparent hover:border-domo hover:shadow-xl transition-all duration-300 group h-full flex flex-col items-center text-center">
              ...
              <h3 className="text-h4 font-bold text-torre mb-3"><span className="domonow-gradient">DomoNow</span> te avisa y te acompaña</h3>
      ...
      <section className="py-24 bg-gradient-to-br from-white to-purple-100 text-torre text-center px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <h2 className="text-h3 font-bold mb-8 leading-tight text-torre">Cumplir no debería ser una carga diaria. Con <span className="domonow-gradient">DomoNow</span>, el cumplimiento se gestiona con orden, anticipación y tranquilidad.</h2>
