    ...
    const t = {
        es: {
            ...
            useCases: {
                title: "Casos de uso",
                items: [
                    { category: "Emergencias médicas dentro del apartamento", videoUrl: "" },
                    { category: "Situaciones de riesgo en zonas comunes", videoUrl: "" },
                    { category: "Incidentes que requieren atención inmediata", videoUrl: "https://youtu.be/KzmzGC0z6OQ?si=X0viaw5OB6qnV6Ox" },
                    { category: "Adultos mayores que necesitan ayuda rápida", videoUrl: "https://youtu.be/DTUiFK9tTjw?si=-g55FHS1V4tbxrBT" }
                ]
            },
            howItWorks: {
        ...
        en: {
            ...
            useCases: {
                title: "Use cases",
                items: [
                    { category: "Medical emergencies inside the apartment", videoUrl: "" },
                    { category: "Risk situations in common areas", videoUrl: "" },
                    { category: "Incidents requiring immediate attention", videoUrl: "https://youtu.be/KzmzGC0z6OQ?si=X0viaw5OB6qnV6Ox" },
                    { category: "Seniors who need quick help", videoUrl: "https://youtu.be/DTUiFK9tTjw?si=-g55FHS1V4tbxrBT" }
                ]
            },
            howItWorks: {
