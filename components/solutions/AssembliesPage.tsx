        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
            <div className="lg:w-5/12 relative z-20">
              <span className="inline-block py-1.5 px-4 rounded-full bg-purple-50 border border-purple-100 text-domo text-tiny font-bold tracking-widest uppercase mb-6">Módulo 09</span>
              <h1 className="text-h2 md:text-h1 font-bold leading-tight mb-6 text-torre"><span className="text-domo">Asambleas</span></h1>
              <div className="prose text-lead text-gray-500 mb-8 leading-relaxed">
                <p>DomoNow transforma las asambleas en procesos <strong>ordenados, transparentes y confiables</strong>, eliminando dudas, reprocesos y conflictos posteriores.</p>
              </div>
                ...
                <div className="absolute bottom-[-10%] left-0 md:-left-4 z-10 w-[240px] md:w-[300px]">
                  <div className="bg-white p-6 rounded-[2.5rem] shadow-[0_30px_80px_rgba(130,10,209,0.25)] border border-gray-100 transform rotate-1 transition-all duration-500">
                    <div className="text-center p-6 bg-gray-50 rounded-2xl mb-4">
                      <h3 className="font-bold text-torre mb-2">Quórum Actual</h3>
                      <p className="text-4xl font-bold text-domo">51%</p>
                      <div className="text-xs text-green-500 mt-2 font-bold">Asamblea Habilitada</div>
                    </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <div className="relative inline-block">
              ...
              <p className="relative z-10 text-h4 text-gray-500 leading-relaxed font-medium">"Convocar y realizar asambleas suele ser desgastante: baja asistencia, dudas sobre quórum, votaciones informales y actas que tardan días."</p>
            </div>
          </div>
