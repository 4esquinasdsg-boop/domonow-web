    ...
    <div className="pt-20 bg-white font-sans text-torre">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
            <div className="lg:w-5/12 relative z-20">
              <div className="flex items-center gap-3 mb-0">
                ...
                <span className="text-base font-bold tracking-widest uppercase text-domo">DOCUMENTAL</span>
              </div>
              <p className="text-small text-gray-400 italic mb-4 ml-12">Documentos organizados, accesibles y seguros</p>
              <h1 className="text-h2 md:text-h1 font-bold leading-tight mb-6 text-torre">
                "¿Dónde quedó<br />
                <span className="text-domo">el reglamento?"</span>
              </h1>
              <div className="prose text-lead text-gray-500 mb-8 leading-relaxed">
                <p className="mb-4 text-torre font-bold">
                  Archivos en carpetas personales, que generan búsquedas eternas.
                </p>
                <p>
                  <strong className="text-torre"><span className="domonow-gradient">DomoNow</span> centraliza todos los documentos.</strong> Encuentras lo que necesitas en segundos.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 border border-gray-100 group hover:border-red-100 transition-colors duration-300 flex flex-col h-full">
              ...
              <div className="space-y-8 flex-grow">
                {[{ title: "Documentos Perdidos", desc: "Horas buscando contratos extraviados" }, { title: "Versiones Confusas", desc: "Múltiples copias del mismo archivo" }, { title: "Riesgos de Cumplimiento", desc: "Vencimientos ignorados" }].map((item, i) => (
            ...
            <div className="bg-[#F9F5FF] p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-domo/5 border border-purple-100 group hover:border-domo/30 transition-colors duration-300 flex flex-col h-full">
              ...
              <div className="space-y-8 flex-grow">
                {[{ title: "Control total", desc: "Encuentra cualquier documento en segundos" }, { title: "Trazabilidad Completa", desc: "Historial de cambios y versiones" }, { title: "Seguridad garantizada", desc: "Respaldos automáticos y permisos por usuario" }].map((item, i) => (
      ...
      <section className="py-24 bg-gradient-to-br from-white to-purple-100 text-torre text-center px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <h2 className="text-h3 font-bold mb-8 leading-tight text-torre">Organiza hoy la documentación de tu comunidad con <span className="domonow-gradient">DomoNow</span>. Empieza a gestionar con menos fricción y más control desde un solo lugar.</h2>
