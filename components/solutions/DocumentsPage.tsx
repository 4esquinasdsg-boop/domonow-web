  ...
  const t = {
    es: {
      ...
      useCases: {
        title: "Casos de uso",
        items: [
          { category: "Manual de convivencia", description: "Residentes consultan el manual de convivencia" },
          { category: "Actas", description: "Junta directiva revisa actas y documentos en segundos" },
          { category: "Bienvenida", description: "Nuevos residentes acceden a la información clave desde el primer día" },
          { category: "Consultas", description: "Administración responde consultas sin buscar uno por uno" }
        ]
      },
      howItWorks: {
    ...
    en: {
      ...
      useCases: {
        title: "Use cases",
        items: [
          { category: "Community Manual", description: "Residents consult the community manual" },
          { category: "Minutes", description: "Board of directors reviews minutes and documents in seconds" },
          { category: "Welcome", description: "New residents access key information from day one" },
          { category: "Inquiries", description: "Administration answers inquiries without searching one by one" }
        ]
      },
      howItWorks: {
