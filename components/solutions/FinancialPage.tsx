  ...
  const t = {
    es: {
      ...
      useCases: {
        title: "Casos de uso",
        items: [
          { category: "Confianza", description: "Desconfianza por falta de información clara sobre gastos" },
          { category: "Claridad", description: "Residentes que no saben cuánto deben ni cuándo vence" },
          { category: "Agilidad", description: "Reportes contables que toman días en generarse" },
          { category: "Recaudo", description: "Facilidad de pago desde cualquier sitio" }
        ]
      },
      howItWorks: {
    ...
    en: {
      ...
      useCases: {
        title: "Use cases",
        items: [
          { category: "Trust", description: "Distrust due to lack of clear information on expenses" },
          { category: "Clarity", description: "Residents who don't know how much they owe or when it's due" },
          { category: "Agility", description: "Accounting reports that take days to generate" },
          { category: "Collection", description: "Ease of payment from anywhere" }
        ]
      },
      howItWorks: {
