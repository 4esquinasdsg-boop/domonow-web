    ...
    <div className="pt-20 bg-white font-sans text-torre">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
            <div className="lg:w-5/12 relative z-20">
              <span className="inline-block py-1.5 px-4 rounded-full bg-purple-50 border border-purple-100 text-domo text-tiny font-bold tracking-widest uppercase mb-6">Módulo 06</span>
              <h1 className="text-h2 md:text-h1 font-bold leading-tight mb-6 text-torre">Votaciones y <br/><span className="text-domo">encuestas</span></h1>
              <div className="prose text-lead text-gray-500 mb-8 leading-relaxed">
                <p>Tomar decisiones en comunidad no tiene por qué generar dudas ni conflictos. DomoNow facilita <strong>votaciones y encuestas claras y confiables</strong>, para que cada decisión quede bien respaldada.</p>
              </div>
        ...
        <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
                    ...
                    <p className="text-body text-gray-500 leading-relaxed">Los residentes reciben la notificación y votan de forma simple y segura.</p>
                </div>
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group h-full flex flex-col">
                    <div className="flex justify-between items-start mb-8"><div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-torre group-hover:bg-domo group-hover:text-white transition-colors"><FileText size={20} /></div><span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-3">PASO 3</span></div>
                    <h3 className="text-h4 font-bold text-torre mb-3">Resultados claros y respaldados</h3>
                    <p className="text-body text-gray-500 leading-relaxed">Los resultados se consolidan automáticamente y quedan registrados para consulta y acta.</p>
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#E9D5FF] text-torre text-center px-6 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-3xl relative z-10">
              <h2 className="text-h2 font-bold mb-8 leading-tight text-torre">Empieza a tomar decisiones claras y sin fricción con DomoNow.</h2>
